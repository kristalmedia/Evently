    ...
    <>
      ...
      {open && (
        <div className="md:hidden">
          ...
          />
          {/* Drawer — fixed to the viewport with explicit top/bottom so height is guaranteed */}
          <aside
            role="dialog"
            aria-modal="true"
            aria-label="Navigation"
            style={{ backgroundColor: drawerBg }}
            className="fixed top-0 bottom-0 left-0 z-50 w-[88vw] max-w-[320px] border-r border-border flex flex-col shadow-2xl animate-in slide-in-from-left duration-200"
          >
